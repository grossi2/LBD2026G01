...
CREATE TABLE Clientes(
    ...
    Apellidos    VARCHAR(50) NOT NULL CHECK (Apellidos REGEXP '^[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+$'), -- Controlamos que Empiece con Mayuscula y no con un numero/simbolo
    Nombres      VARCHAR(30) NOT NULL CHECK (Nombres REGEXP '^[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+$'), -- Controlamos que Empiece con Mayuscula y no con un numero/simbolo
    Correo       VARCHAR(60),
...
(1, 1, 2, NULL, 1, 		'2026-03-05 10:31:34', 'F'),  -- Despacho al cliente 1 (Juan Lopez)
(2, 2, 2, NULL, 2, 		'2026-03-12 17:21:20', 'F'),  -- Envío al cliente 2 (Maria Garcia)
(3, NULL, 1, 2, 1, 		'2026-03-17 09:05:43', 'F'),  -- Transferencia interna
(4, 4, 2, NULL, 3, 		'2026-03-21 19:33:26', 'P'),  -- Envío al cliente 4 (Laura Martinez)
(5, 5, 2, NULL, 1, 		'2026-03-26 11:15:52', 'F'),  -- Despacho al cliente 5 (Pedro Gomez)
(6, NULL, 3, 2, 5, 		'2026-04-01 13:01:14', 'F'), 
(7, 7, 5, NULL, 2, 		'2026-04-06 13:01:14', 'P'), 
(8, 8, 2, NULL, 4, 		'2026-04-14 13:01:14', 'F'), 
(9, NULL, 2, 5, 1, 		'2026-04-15 13:01:14', 'F'), 
(10, 10, 8, NULL, 3, 	'2026-04-15 13:01:14', 'P'), 
(11, 11, 2, NULL, 2, 	'2026-04-18 13:01:14', 'F'), 
(12, 12, 4, NULL, 1, 	'2026-04-25 13:01:14', 'F'), 
(13, NULL, 15, 16, 5, 	'2026-04-25 13:01:14', 'F'), 
(14, 14, 2, NULL, 10, 	'2026-04-28 13:01:14', 'P'), 
(15, 15, 18, NULL, 2, 	'2026-05-02 13:01:14', 'F'),
(16, NULL, 1, 2, 11, 	'2026-05-05 13:01:14', 'F'), 
(17, 17, 2, NULL, 13,   '2026-05-07 13:01:14', 'P'), 
(18, 18, 5, NULL, 12, 	'2026-05-13 13:01:14', 'F'), 
(19, NULL, 19, 14, 14, 	'2026-05-17 13:01:14', 'P'), 
(20, NULL, 5, 18, 15,   '2026-05-23 13:01:14', 'F'),
(21, NULL, 2, 18, 15,  	'2026-05-23 13:01:14', 'F'),
(22, NULL, 2, 18, 15,   '2026-05-23 13:01:14', 'F'),
(23, 5, 2, NULL, 15,    '2026-05-24 13:01:14', 'F'),
(24, 5, 2, NULL, 15,    '2026-05-26 13:01:14', 'F'),
...
DELIMITER //
CREATE PROCEDURE ActualizarPreciosPorcentaje(pPorcentaje DECIMAL(5,2), pMontoFijo DECIMAL(12,2), OUT mensaje VARCHAR(100))
-- 	Se aumentan los precios primero en base al porcentaje y luego se le suma el monto fijo, si alguno de estos parametros es
-- nulo o 0 simplemente se lo ignora y se aplica el que no sea nulo
SALIR: BEGIN
	DECLARE pUltimoID INT;
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
	BEGIN
		ROLLBACK;
        SET mensaje = 'Se genero un precio negativo';
	END;
    ...
    INSERT INTO Precios (SELECT IdProducto, LAST_INSERT_ID(), (Precio * (1 + (pPorcentaje / 100)) + pMontoFijo) FROM Precios WHERE IdListaPrecio = pUltimoID);
    COMMIT;
